 ...
 *  @version $Revision: 3768 $
 *           $Id: GL11.java 3768 2012-05-04 17:23:36Z spasi $
 */
public final class GL11 {
	...
	public static void glBitmap(int width, int height, float xorig, float yorig, float xmove, float ymove, ByteBuffer bitmap) {
		...
		nglBitmap(width, height, xorig, yorig, xmove, ymove, MemoryUtil.getAddress(bitmap), function_pointer);
	}
