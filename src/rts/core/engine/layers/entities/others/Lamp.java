...
public class Lamp extends Misc implements IBigEntity {

	private Image lamp;

	public Lamp(Engine engine, int networkId) {
		super(engine, EData.OLD_LAMP, networkId);
		lamp = ResourceManager.getImage("old_lamp");
		width = lamp.getWidth();
